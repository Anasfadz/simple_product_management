    ...
    <MainLayout>
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between">
                <div>
                    ...
                    <p class="text-white/80 font-medium max-w-lg leading-relaxed text-sm">
                        Welcome back to StockOps. Here's what's happening with your inventory and products today.
                    </p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm hover:shadow-lg transition-shadow duration-300 relative overflow-hidden group">
                ...
                <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Total Products</h3>
            ...
            <div class="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm hover:shadow-lg transition-shadow duration-300 relative overflow-hidden group">
                ...
                <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Inventory Value</h3>
                ...
                <div class="flex items-center text-xs font-bold">
                    ...
                    <span class="text-gray-400">tracked live</span>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm hover:shadow-lg transition-shadow duration-300 relative overflow-hidden group">
                ...
                <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Low Stock Alerts</h3>
                ...
                <div class="flex items-center text-xs font-bold">
                    ...
                    <span class="text-gray-400">requires attention</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm mb-12">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h3 class="text-lg font-black text-gray-900 tracking-tight">Top 10 High-Value Products</h3>
                    <p class="text-xs font-bold text-gray-400 mt-1 uppercase tracking-widest">Cumulative Inventory Value (Price × Stock)</p>
                </div>
                <div class="flex items-center space-x-2">
                    <span class="w-3 h-3 bg-orange-500 rounded-full"></span>
                    <span class="text-[10px] font-black text-gray-500 uppercase tracking-widest">Total Value (RM)</span>
                </div>
            </div>
