                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr>
                            ...
                            <th class="py-4 px-6 border-b border-gray-100 font-bold text-[11px] uppercase tracking-wider text-gray-400">Category Name</th>
                            <th class="py-4 px-6 border-b border-gray-100 font-bold text-[11px] uppercase tracking-wider text-gray-400">Date Added</th>
                            <th class="py-4 px-6 border-b border-gray-100 font-bold text-[11px] uppercase tracking-wider text-gray-400 text-right">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr v-if="categories.data.length === 0">
                            <td colspan="4" class="py-12 text-center">
                                <div class="flex flex-col items-center justify-center text-gray-400">
                                    ...
                                    <p class="text-xs mt-1">Get started by creating a new category.</p>
                                </div>
                            </td>
                        </tr>
                    </tbody>
